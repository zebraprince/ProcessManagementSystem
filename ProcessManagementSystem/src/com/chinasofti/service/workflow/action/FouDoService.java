...
public class FouDoService implements IFirDoService {
		...
		if (decide.equals("1")) {
			...
			if (taskInstance.hasEnded() || pInstance.hasEnded())
				...
				if (pInstance.hasEnded()) {
					...
					List<?> list = tms.findTaskInstances("chief4");
					...
					while (iterator.hasNext()) {
						...
						if (processInstance != null
							...
							if (pid == (Integer) iaInstance
									.getVariable("proid")
									&& (Integer) iaInstance
											.getVariable("state") - 10 == 7) {

								iaInstance.setVariable("state", 18);
								jb.save(iaInstance);

								// request.getSession().setAttribute("content",
								// content);
								// request.getSession().setAttribute("processid",
								// processid);
					...
					while (iterator.hasNext()) {
						...
						if (processInstance != null
							...
							if (pid == (Integer) iaInstance
								...
								iaInstance.setVariable("state", 32);
