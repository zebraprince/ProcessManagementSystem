...
public class SecDoService implements IFirDoService {
		...
		if (decide.equals("1")) {
			...
			if (taskInstance.hasEnded() || pInstance.hasEnded())
				...
				if (pInstance.hasEnded()) {
					...
					List<?> list = tms.findTaskInstances("chief2");
					...
					while (iterator.hasNext()) {
						...
						if (processInstance != null
							...
							if (pid == (Integer) iaInstance.getVariable("proid")
									&& (Integer) iaInstance
											.getVariable("state") - 10 == 3) {

								iaInstance.setVariable("state", 14);
								jb.save(iaInstance);
					...
					while (iterator.hasNext()) {
						...
						if (processInstance != null
							...
							if (pid == (Integer) iaInstance.getVariable("proid")
								...
								iaInstance.setVariable("state", 40);
								jb.save(iaInstance);
