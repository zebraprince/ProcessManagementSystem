 ...
 * 
 * XDoclet definition:
 * @struts.action path="/uchange" name="uchangeForm" input="/technologymanagementsys/userchange.jsp" scope="request" validate="true"
 * @struts.action-forward name="change" path="/technologymanagementsys/tab/userchange.jsp"
 */
public class UchangeAction extends Action {
	/*
	 * Generated Methods
	 */
